...
public class SwaggerConfig {
	...
	private ApiInfo metaData() {
		return new ApiInfo("Ecommerce Products RESTfull API ", "Ecommerce Products REST API for online store", "1.0.0", 
				"Term of service as per user guide lines.", 
				new Contact("John Smith", "http://ecom.smith.com/about", "help@gmail.com"), 
